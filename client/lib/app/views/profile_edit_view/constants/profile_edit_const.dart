...
class ProfileEditConstants {
  ...
  static TextEditingController? peNameSurnameController =
  ...
  List<TextEditingController?> changePasswordControllers() {
    return [changePassCurrent, changePassNew, changePassNewAgain];
  }

  List<TextEditingController?> profileEditControllers() {
    return [
      peNameSurnameController,
      peEmailController,
      pePhoneController,
      peTcController
    ];
  ...
  List<String> changePassLabels(BuildContext context) {
    return ["mevcut şifre", "yeni şifre", "yeni şifre tekrar"];
  }
}
