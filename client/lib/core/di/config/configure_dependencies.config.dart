...
import 'package:client/core/data/network/abstractions/users_service.dart'
    as _i34;
import 'package:client/core/data/network/services/todos/todo_api.dart' as _i33;
import 'package:client/core/data/network/services/users/user_api.dart' as _i35;
import 'package:client/core/di/config/app_config.dart' as _i30;
import 'package:client/core/di/config/raw_helper.dart' as _i21;
import 'package:client/core/di/config/register_module.dart' as _i36;
...
import 'package:client/core/views/founding_members_view/founding.members.viewmodel.dart'
    as _i12;
import 'package:client/core/views/help_view/help.viewmodel.dart' as _i13;
import 'package:client/core/views/home_view/home.viewmodel.dart' as _i14;
import 'package:client/core/views/jobs_details_view/jobs_detail.viewmodel.dart'
    as _i15;
import 'package:client/core/views/jobs_view/jobs.viewmodel.dart' as _i16;
import 'package:client/core/views/mentors_details_view/mentors_details.viewmodel.dart'
    as _i17;
import 'package:client/core/views/mentors_view/mentors.viewmodel.dart' as _i18;
import 'package:client/core/views/news_detail_view/news_detail.viewmodel.dart'
    as _i19;
import 'package:client/core/views/news_view/news.viewmodel.dart' as _i20;
import 'package:client/core/views/settings_view/settings.viewmodel.dart'
    as _i24;
import 'package:client/core/views/signup_view/signup.viewmodel.dart' as _i25;
import 'package:client/core/views/splash_view/splash.viewmodel.dart' as _i26;
...
import 'package:client/core/views/user_profile_view/user_profile.viewmodel.dart'
    as _i28;
import 'package:client/core/views/videos_view/videos.viewmodel.dart' as _i29;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i8.ChangeThemeViewModel>(() => _i8.ChangeThemeViewModel());
  ...
  gh.factory<_i11.ForgotPasswordViewModel>(
      () => _i11.ForgotPasswordViewModel());
  gh.factory<_i12.FoundingMembersViewModel>(
      () => _i12.FoundingMembersViewModel());
  gh.factory<_i13.HelpViewModel>(() => _i13.HelpViewModel());
  gh.factory<_i14.HomeViewModel>(() => _i14.HomeViewModel());
  gh.factory<_i15.JobsDetailViewModel>(() => _i15.JobsDetailViewModel());
  gh.factory<_i16.JobsViewModel>(() => _i16.JobsViewModel());
  gh.factory<_i17.MentorsDetailsViewModel>(
      () => _i17.MentorsDetailsViewModel());
  gh.factory<_i18.MentorsViewModel>(() => _i18.MentorsViewModel());
  gh.factory<_i19.NewsDetailViewModel>(() => _i19.NewsDetailViewModel());
  gh.factory<_i20.NewsViewModel>(() => _i20.NewsViewModel());
  await gh.singletonAsync<_i21.RawConfig>(
    () => registerModule.config(),
    preResolve: true,
  );
  gh.factory<_i22.SampleViewModel>(() => _i22.SampleViewModel());
  gh.factory<_i23.SampleViewModelTwo>(() => _i23.SampleViewModelTwo());
  gh.factory<_i24.SettingsViewModel>(() => _i24.SettingsViewModel());
  gh.factory<_i25.SignUpViewModel>(() => _i25.SignUpViewModel());
  gh.factory<_i26.SplashViewModel>(() => _i26.SplashViewModel());
  gh.factory<_i27.SupportInstutionsViewModel>(
      () => _i27.SupportInstutionsViewModel());
  gh.factory<_i28.UserProfileViewModel>(() => _i28.UserProfileViewModel());
  gh.factory<_i29.VideosViewModel>(() => _i29.VideosViewModel());
  gh.singleton<_i30.AppConfig>(_i30.AppConfig(get<_i21.RawConfig>()));
  gh.singleton<_i31.Dio>(registerModule.dio(get<_i30.AppConfig>()));
  gh.factory<_i32.TodosService>(() => _i33.RestTodoService(
        get<_i31.Dio>(),
        get<_i30.AppConfig>(),
      ));
  gh.factory<_i34.UserService>(() => _i35.RestUserService(
        get<_i31.Dio>(),
        get<_i30.AppConfig>(),
      ));
  return get;
