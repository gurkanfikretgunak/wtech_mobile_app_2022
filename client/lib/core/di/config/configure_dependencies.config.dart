...
import 'package:client/core/data/network/abstractions/users_service.dart'
    as _i36;
import 'package:client/core/data/network/services/todos/todo_api.dart' as _i35;
import 'package:client/core/data/network/services/users/user_api.dart' as _i37;
import 'package:client/core/di/config/app_config.dart' as _i32;
import 'package:client/core/di/config/raw_helper.dart' as _i23;
import 'package:client/core/di/config/register_module.dart' as _i38;
...
import 'package:client/core/views/settings_view/settings.viewmodel.dart'
    as _i26;
import 'package:client/core/views/signup_view/signup.viewmodel.dart' as _i27;
import 'package:client/core/views/splash_view/splash.viewmodel.dart' as _i28;
...
import 'package:client/core/views/user_profile_view/user_profile.viewmodel.dart'
    as _i30;
import 'package:client/core/views/videos_view/videos.viewmodel.dart' as _i31;
...
Future<_i1.GetIt> $initGetIt(
  ...
  await gh.singletonAsync<_i23.RawConfig>(
    () => registerModule.config(),
    preResolve: true,
  );
  gh.factory<_i24.SampleViewModel>(() => _i24.SampleViewModel());
  gh.factory<_i25.SampleViewModelTwo>(() => _i25.SampleViewModelTwo());
  gh.factory<_i26.SettingsViewModel>(() => _i26.SettingsViewModel());
  gh.factory<_i27.SignUpViewModel>(() => _i27.SignUpViewModel());
  gh.factory<_i28.SplashViewModel>(() => _i28.SplashViewModel());
  gh.factory<_i29.SupportInstutionsViewModel>(
      () => _i29.SupportInstutionsViewModel());
  gh.factory<_i30.UserProfileViewModel>(() => _i30.UserProfileViewModel());
  gh.factory<_i31.VideosViewModel>(() => _i31.VideosViewModel());
  gh.singleton<_i32.AppConfig>(_i32.AppConfig(get<_i23.RawConfig>()));
  gh.singleton<_i33.Dio>(registerModule.dio(get<_i32.AppConfig>()));
  gh.factory<_i34.TodosService>(() => _i35.RestTodoService(
        get<_i33.Dio>(),
        get<_i32.AppConfig>(),
      ));
  gh.factory<_i36.UserService>(() => _i37.RestUserService(
        get<_i33.Dio>(),
        get<_i32.AppConfig>(),
      ));
  return get;
