...
import 'package:client/core/data/network/services/users/user_api.dart' as _i16;
import 'package:client/core/di/config/app_config.dart' as _i11;
import 'package:client/core/di/config/raw_helper.dart' as _i6;
import 'package:client/core/di/config/register_module.dart' as _i17;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i9.UserProfileViewModel>(() => _i9.UserProfileViewModel());
  gh.factory<_i10.VideosViewModel>(() => _i10.VideosViewModel());
  gh.singleton<_i11.AppConfig>(_i11.AppConfig(get<_i6.RawConfig>()));
  gh.singleton<_i12.Dio>(registerModule.dio(get<_i11.AppConfig>()));
  gh.factory<_i13.TodosService>(() => _i14.RestTodoService(
        get<_i12.Dio>(),
        get<_i11.AppConfig>(),
      ));
  gh.factory<_i15.UserService>(() => _i16.RestUserService(
        get<_i12.Dio>(),
        get<_i11.AppConfig>(),
      ));
  return get;
