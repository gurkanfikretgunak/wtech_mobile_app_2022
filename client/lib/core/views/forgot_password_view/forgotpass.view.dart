    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
              ...
              text(L10n.of(context)!.forgotPassword, TextStyle(fontSize: 15,fontWeight: FontWeight.w400,color: ColorConstant.instance.grey)),
              const Padding(padding: EdgeInsets.only(top: 20)),
              text(L10n.of(context)!.forgotPasswordDescription, TextStyle(fontSize: 15,fontWeight: FontWeight.w400,color: ColorConstant.instance.grey)),
              const Padding(padding: EdgeInsets.only(top: 20)),
              textButton(L10n.of(context)!.backLogin,TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: ColorConstant.instance.blue),(){}),
              const Padding(padding: EdgeInsets.only(top: 20)),
