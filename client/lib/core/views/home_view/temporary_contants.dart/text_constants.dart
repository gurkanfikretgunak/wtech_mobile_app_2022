...
class HomeTextContants {
  ...
  static List<String> eventPath = [
    ...
    Assets.images.dijitalSanatlar.path,
    Assets.images.happyFriday.path
  ];
  static List<String> trainingPath = [
    Assets.images.saglik.path,
    Assets.images.egeEgitim.path,
    Assets.images.turkTraktor.path
  ];
}
